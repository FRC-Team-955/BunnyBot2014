...
public class Config {
    ...
    public static class MyJoystick {
        ...
        public static final int chnTwo = 2;
        ...
        public static final int btSingleMode = 5;
        public static final int btDualMode = 6;
        public static final int btClawOpen = 2;
        public static final int btClawClose = 4;
        public static final int btArmUp = 8;
        public static final int btArmDown = 7;
        public static final int btArmManual = 9;
        public static final int btArmAutomatic = 10;
    }

    public static class MyJoystickTwo {

        public static final int btClawOpen = 4;
        public static final int btClawClose = 2;
        public static   int btArmUp = 5;
        public static final int btArmDown = 6;
    ...
    public static class Drive {
        ...
        public static final double turningScalar= 0.5;
    ...
    public static class Auto {
        ...
        public static final int idDropBunny = 2;
        public static final int idDropBunnyTimed = 3;

        // Times/Speeds for auto routines
        public static final int driveForwardTime = 2;
        public static final double driveForwardSpeed = 1;
        public static final double driveBackwardTime = 0.5;
        public static final double driveBackwardSpeed = 1;
        public static final double intakeCloseTime = 1.25;
        public static final double intakeOpenTime = 0.75;
        public static final double intakeDownTime = 2;
    ...
    public static class Station {
        ...
        public static final int chnAutoDoNothing = 1;
        public static final int chnAutoDropBunny = 2;
        public static final int chnAutoDropBunnyTimed = 3;
